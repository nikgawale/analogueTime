...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var thumbGradientColors: [UIColor]? = [UIColor.clear,UIColor.clear]
    @IBInspectable open var thumbShadowColor: UIColor = UIColor.clear
    @IBInspectable open var useShadow:Bool = true
    
    //left and right space between items
    @IBInspectable open var padding: CGSize = CGSize(width: 25, height: 10)
