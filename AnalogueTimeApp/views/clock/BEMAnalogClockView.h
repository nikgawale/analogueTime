...
@property (strong, nonatomic) IBInspectable UIImage *hourHandImage;
...
@property (strong, nonatomic) IBInspectable UIImage *minuteHandImage;
...
- (void)userPutsOfHisFingureOutOfClock;

- (void)userMovingHandAntiClockwise;
